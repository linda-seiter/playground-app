...
//Week#1
infected *= r0;
console.log(`Week 1: ${infected} people are infected with ${virus}.`);

//Week#2
infected *= r0;
console.log(`Week 2: ${infected} people are infected with ${virus}.`);

//Week#3
infected *= r0;
console.log(`Week 3: ${infected} people are infected with ${virus}.`);
